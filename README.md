...
This project was built following [admin-on-rest tutorial](https://marmelab.com/admin-on-rest//Tutorial.html).

```
npm install -g create-react-app
create-react-app cibuci-admin
cd cibuci-admin/
yarn add admin-on-rest
yarn start
```

Then, with [aor-loopback](https://github.com/kimkha/aor-loopback) help:

```
yarn add aor-loopback
```

we can have a rest client fit for [cibuci-api](https://github.com/cibuci/cibuci-api):
